...
import com.shamanthaka.scala.pca.rf.RFPCARainfallModel.data
...
/**
  ...
  */
object RFYearModel extends App{
  ...
  val data = sparkSession.read.format("libsvm").load("year1_libsvm_data.txt")
  //show schema
  ...
  model.write.overwrite().save("rfYearModel");
  ...
  predictions.select("prediction","label","probability", "outFeatures").show(100)
