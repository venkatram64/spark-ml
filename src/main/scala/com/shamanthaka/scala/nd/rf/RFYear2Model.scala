...
/**
  ...
  */
object RFYear2Model extends App{

  val sparkSession = SparkSession
    .builder()
    .master("local")
    .appName("RFYear2Model")
    .getOrCreate()


  val data = sparkSession.read.format("libsvm").load("year2_libsvm_data.txt")
  //show schema
  ...
  model.write.overwrite().save("rfYear2Model");
