...
/**
  ...
  */
object RFYear2Prediction extends App{


  val sparkSession = SparkSession
    .builder()
    .master("local")
    .appName("RFYear2Prediction")
    .getOrCreate()

  val testData = sparkSession.read.format("libsvm").load("year2_libsvm_test_data.txt")
  //show schema
  ...
  val model = PipelineModel.load("rfYear2Model")
