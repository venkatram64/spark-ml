...
/**
  ...
  */
object DTDermatologyPrediction extends App{

  val sparkSession = SparkSession
    .builder()
    .master("local")
    .appName("DTDermatologyPrediction")
    .getOrCreate()


  val data = sparkSession.read.format("libsvm").load("dermatology_libsvm_data.txt")
  //show schema
  data.printSchema()
  ...
  model.write.overwrite().save("dtDermatologyModel");
