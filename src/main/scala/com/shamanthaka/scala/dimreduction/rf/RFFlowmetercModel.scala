...
/**
  ...
  */
object RFFlowmetercModel extends App{

  val sparkSession = SparkSession
    .builder()
    .master("local")
    .appName("RFFlowmetercModel")
    .getOrCreate()


  val data = sparkSession.read.format("libsvm").load("flowmeterc_libsvm_data")
  //show schema
  ...
  model.write.overwrite().save("rfFlowmetercModel");
