...
/**
  ...
  */
object RFFlowmeterbModel extends App{

  val sparkSession = SparkSession
    .builder()
    .master("local")
    .appName("RFFlowmeterbModel")
    .getOrCreate()


  val data = sparkSession.read.format("libsvm").load("flowmeterb_libsvm_data")
  //show schema
  ...
  model.write.overwrite().save("rfFlowmeterbModel");
