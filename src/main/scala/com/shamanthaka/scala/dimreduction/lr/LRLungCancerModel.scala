...
/**
  ...
  */
object LRLungCancerModel extends App{

  val sparkSession = SparkSession
    .builder()
    .master("local")
    .appName("LRLungCancerModel")
    .getOrCreate()


  val data = sparkSession.read.format("libsvm").load("lungcancer_libsvm_data.txt")
  //show schema
  data.printSchema()
  ...
  model.write.overwrite().save("lrLungCancerModel");
