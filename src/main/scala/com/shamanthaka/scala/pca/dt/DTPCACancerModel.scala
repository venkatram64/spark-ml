...
/**
  ...
  */
object DTPCACancerModel extends App{

  val sparkSession = SparkSession
    .builder()
    .master("local")
    .appName("DTPCACancerModel")
    .getOrCreate()
  ...
  model.write.overwrite().save("dtPCACancerModel");
  ...
  //predictions.select("predictedLabel", "label", "probability", "pcaFeatures").show(300)
